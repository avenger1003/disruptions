...
global $bd, $wpdb, $current_user;   
    ...
    if( $_POST['business_contact_person'] ) $contact = $_POST['business_contact_person'];
    if( $_POST['business_phone_number'] ) $phone = $_POST['business_phone_number'];
    if( $_POST['business_website'] ) $website = $_POST['business_website'];
    if ( $_POST['checkmode'] ){
